...
public class Storage {
    ...
    public static boolean addGroup(Group addedGroup, Long id, List<Group> groups, boolean addToRoot) {
    ...
    public static boolean addItem(Item addedItem, Long id, List<Group> groups) {
        boolean isAdded = false;
        List<Group> copyGroup = new ArrayList<>(groups);
        Group g;
        Iterator<Group> iterator = copyGroup.iterator();
    ...
    public static void deleteItem(Long id) throws ItemNotFoundException {
        for (Group group : groups) {
            Optional<Item> item = group.getItems()
                    .stream()
    ...
    public static void updateItem(Long id, String newName) throws ItemNotFoundException {
        for (Group group : groups) {
            Optional<Item> item = group.getItems()
                    .stream()
                    .filter(b -> b.getId().equals(id))
